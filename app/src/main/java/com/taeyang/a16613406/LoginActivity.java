    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Thread(){
            public void run(){
                ...
                String aresult;
                try{
                    URL url=new URL("http://183.100.142.142:8080/get_sheet_info.php");
...
//                    conn.setUseCaches(false);
    ...
    public void JSON_parser(String b_result){
        ...
        try {
            ...
            int cnt=Integer.parseInt(jsonObject.get("sheetCnt").toString());
    ...
    Handler mAfterDown=new Handler(){
        public void handleMessage(Message msg) {
            final Spinner spinner = (Spinner)findViewById(R.id.apart_name);
            ...
            spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener(){
                ...
                public void onItemSelected(AdapterView<?> parent,View view, int position, long id){
                    ...
                    apt=spinner.getSelectedItem().toString();
                }
                @Override
